...
//매개 변수(Parameter)
// - 함수가 호출될 때 전달된 값을(전달 인자, Argumetn)을 
//   저장하기 위한 변수

/** switch 문을 이용한 계산기 */
function clac(op){
  console.log("매개 변수 op 확인 : ", op, typeof op); // typeof op로 작성하면 어떤 문장인지 알려준다
...
function check6(){
  ...
  //    현재 case 수행 후 멈추지 않고
  //    다음 case를 연달아서 수행
  // (break 또는 switch 끝)을 만날 때 까지 계속 연달아 수행
