...
function Student(grade, ban, number, name){
  ...
  this.inform = function(){
    let str 
    = `${this.grade}학년 ${this.ban}반 ${this.number}번 이름 ${this.name} `;
    return str;
  }
}
...
checkJson.addEventListener("click", () => {
  ...
  // JSON.parse(JSNO문자열) : JSON문자열 -> JS 객체
