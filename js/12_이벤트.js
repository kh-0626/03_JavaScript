...
const c = document.querySelectorAll(".inputColor");

const b = document.querySelectorAll(".display");

/* 변경하기 버튼이 클릭 되었을 때 */
btn.addEventListener("click", function(){

  for(let cls = 0 ; cls < b.length ; cls++){
      // c번재 .inputColor에 작성된 값을 얻어와 
      // b번째 .display에 배경색으로 대입
      b[cls].style.backgroundColor = c[cls].value
  }
});


// btn > addEventListener >
//  b or c 길이체크 for문 > b[i].style.back = c.value